...
// 		if (FlxG.save.data.musicPreload == null || FlxG.save.data.charPreload == null || FlxG.save.data.graphicsPreload == null)
// 		{
// 			FlxG.save.data.musicPreload = false;
// 			FlxG.save.data.charPreload = false;
// 			FlxG.save.data.graphicsPreload = false;
// 		}

// 		settings = [
// 			FlxG.save.data.musicPreload,
// 			FlxG.save.data.charPreload,
// 			FlxG.save.data.graphicsPreload
// 		];
